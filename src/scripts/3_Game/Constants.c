...
const float SEPSIS_ZOMBIE_HIT_CHANCE = 0.02;
const float SEPSIS_KNIFE_HIT_CHANCE = 0.02;
const float SEPSIS_BULLET_HIT_CHANCE = 0.01;
...
const float ZVIRUS_ZOMBIE_HIT_CHANCE = 0.05;
