...
const float SLEEPING_HEAL_PER_SEC_01 = 0.0006;
const float SLEEPING_HEAL_INFLUENZA_CHANCE = 0.0025;
...
const float SEPSIS_ZOMBIE_HIT_CHANCE = 0.05;
const float SEPSIS_KNIFE_HIT_CHANCE = 0.05;
const float SEPSIS_BULLET_HIT_CHANCE = 0.02;
const float SEPSIS_DIRTY_SYRINGE_CHANCE = 0.3;
const float SEPSIS_DITRY_HANDS_BANDAGE_CHANCE = 0.05;
const float SEPSIS_DITRY_HANDS_SYRGERY_CHANCE = 0.3;
...
const float ZVIRUS_BLOOD_REGEN_PER_SEC = 10;
const float ZVIRUS_ZOMBIE_HIT_CHANCE = 0.075;
...
const float BLEEDING_KNIFEHIT_OPEN_PER_SECOND = 5;
const float BLEEDING_KNIFEHIT_CUPD1_PER_SECOND = 0.3;
const float BLEEDING_KNIFEHIT_CUPD2_PER_SECOND = 0.1;
const float BLEEDING_KNIFEHIT_REMOVE_BANDAGED_TIME_SEC = 60 * 20; // 30 min

const float BLEEDING_VISCERA_BLOODLOSE_PER_SECOND = 2;
