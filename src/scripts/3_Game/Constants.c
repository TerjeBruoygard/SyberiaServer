...
const float ZVIRUS_ANTIDOT_BLOOD_DMG = 3000;
...
const float BLEEDING_BULLETHIT_CUPD1_PER_SECOND = -5;
const float BLEEDING_BULLETHIT_CUPD2_PER_SECOND = -1;
const float BLEEDING_BULLETHIT_REMOVE_BANDAGED_TIME_SEC = -1; // DISABLED

const float BLEEDING_KNIFEHIT_HEALTHLOSE_PER_SECOND = -1;
const float BLEEDING_KNIFEHIT_OPEN_PER_SECOND = -30;
const float BLEEDING_KNIFEHIT_CUPD1_PER_SECOND = -3;
const float BLEEDING_KNIFEHIT_CUPD2_PER_SECOND = -1;
