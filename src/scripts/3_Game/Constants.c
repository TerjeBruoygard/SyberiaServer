...
const float ZVIRUS_DEATH_TIME_SEC = 600;
const float ZVIRUS_BLOOD_REGEN_PER_SEC = 30;
const float ZVIRUS_ZOMBIE_HIT_CHANCE = 0.1;
...
const int STOMATCHPOISON_WATER_DRAIN_FROM_VOMIT[3] = { 150, 300, 500 };
const int STOMATCHPOISON_ENERGY_DRAIN_FROM_VOMIT[3] = { 200, 400, 1000 };
const float STOMATCHHEAL_MODIFIER = 2.5;
